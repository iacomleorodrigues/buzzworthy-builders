...
const testimonials = [
  ...
  { quote: "Já tínhamos trabalhado com outras agências, mas sempre faltava alguém conectando todas as pontas. Com a YedWeb, estratégia, design, conteúdo e execução falam a mesma língua. Hoje nossa presença digital representa muito melhor o nível da empresa.", name: "[SUBSTITUIR — nome]", role: "[SUBSTITUIR — cargo / empresa]" },
];
